...
private:
    ...
    void createInstance()
    {
        ...
        {
            std::cout << "GLFW support requested, but not available!" << '\n';
        }
        ...
        {
            throw std::runtime_error("Failed to create vkCreateInstance!");
        }
    }
